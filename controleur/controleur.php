<?php 
    ...
    } else if(isset($_GET['intervenants']) || isset($_GET['intervenant']) || isset($_GET['supprimer_intervenant']) || isset($_GET['formulaire_ajout_intervenant']) || isset($_GET['ajouter_intervenant'])){
