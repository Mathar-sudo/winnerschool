        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr id="ligne<?= $matiere->get_id_matiere() ?>">
                    ...
                    <td><a href="?formulaire_modifier_matiere=<?= $matiere->get_id_matiere() ?>"><button class="btn btn-info btn-sm"><i class="far fa-edit"></i></button></a></td>
