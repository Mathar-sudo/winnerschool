    ...
    <div class="container">
        ...
        <form class="row g-3 " method="POST" action="?modifier_matiere<?= $matiere->get_id_matiere()?>">
            <div class="col-12">
                ...
                <input type="text" name="nom_matiere" class="form-control" value="<?= $matiere->get_id_matiere()?>" id="input_nom" required>
            </div>
            <div class="col-12 text-center">
                <button type="submit" class="btn btn-primary">Modifier</button>
                <a href="?matieres"><button type="submit" class="btn btn-success">Retour</button></a>
            </div>
        </form>
    </div>
