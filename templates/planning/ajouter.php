<?php $titre_page = 'Ajouter un planning' ?>
...
<?php ob_start(); ?>
    ...
    <div class="container">
        <h1 class="text-primary">Ajouter un nouveau planning</h1>
        <hr style="width:15%">
        <?php if(isset($erreur)){ echo $erreur; } ?>
        <form class="row g-3" method="POST" action="?ajouter_planning">
            <div class="row">
            <div class="col-6">
                <label for="input_intervenant" class="form-label">Intervenant de l'élève</label>
                ...
                <label for="input_eleve" class="form-label">eleve de l'élève</label>
                ...
                <label for="input_pedagogue" class="form-label">Pédagogue de l'élève</label>
                ...
                <label for="input_salle" class="form-label">Salle de l'élève</label>
                ...
                <label for="input_matiere" class="form-label">Matière de l'élève</label>
